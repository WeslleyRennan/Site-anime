...
const img = [
    {'id': '1', 'url':'img/img1.jpeg'},
    {'id': '2', 'url':'img/img2.jpeg'},
    {'id': '3', 'url':'img/img3.jpeg'},
    {'id': '4', 'url':'img/img4.jpeg'},
    {'id': '5', 'url':'img/img5.jpeg'},
]

const containerItems = document.querySelector('#container-items')

const loadImg = (img, container) =>{
    img.forEach( img => {
        container.innerHTML += `
          <div class='item'>
             <img src='${img.url}'>
...
const imgAnime = [
    ...
    {'id': '6', 'url':'img/capa6.jpg', 'texto':'Shingeki no Kyojin 4The Final season - Dublado', 'hrf':'Animes EP/Shingeki no Kyojin 4The Final season - Parte 2/Anime-Shingeki no Kyojin 4The Final season - Parte 2.html'},
...
const iframe = [
    ...
    {'id': '7', 'src':'https://www.youtube.com/embed/wxcvbL6o55M'},
    {'id': '8', 'src':'https://www.youtube.com/embed/HNY3rlgfxvA'},
    {'id': '9', 'src':'https://www.youtube.com/embed/T5nHTuDT88g'},
]
...
const iframeA = [
    ...
    {'id': '5', 'src':'https://www.youtube.com/embed/6r9q_i1O1Q4'},
